...
export const ModalStackScreen = () => (<ModalStack.Navigator initialRouteName="main" mode="modal" screenOptions={() => {
    return {
        headerShown: false,
    ...
    <ModalStack.Screen name="addTimeline" options={() => {
    return {
        headerShown: true,
        title: "New Timeline",
    };
}} component={AddTimelineScreen}/>
    <ModalStack.Screen name="addEvent" options={() => {
    return {
        headerShown: true,
        title: "New Event",
    };
